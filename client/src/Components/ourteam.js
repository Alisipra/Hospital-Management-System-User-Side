        ...
        <div className="row justify-content-center">
            ...
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr.hasan</h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr. Adnan Aslam</h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr. Naeem ul Hassan</h4>
        ...
        <div className="row justify-content-center">
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr.Farjad Afzal </h4>
          ...
          <div className="col-lg-4 col-sm-6 mb-30">
            <div className="team-member">
              ...
              <div className="team-info">
                <div className="team-info-comntent">
                  <h4 className="title">Dr.Faiza Bajwa</h4>
